...
#SBATCH --error=/nfs/research/jlees/jacqueline/thesis_results/gwas_spn_trimethoprim/prediction/12_spn_trimethoprim_MIC_coarse_dilutions_PPOM_random/logs/12_spn_trimethoprim_MIC_coarse_dilutions_PPOM_random.err
#SBATCH --output=/nfs/research/jlees/jacqueline/thesis_results/gwas_spn_trimethoprim/prediction/12_spn_trimethoprim_MIC_coarse_dilutions_PPOM_random/logs/12_spn_trimethoprim_MIC_coarse_dilutions_PPOM_random.out
