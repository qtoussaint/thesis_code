...
#SBATCH --error=/nfs/research/jlees/jacqueline/thesis_results/gwas_tb_rifampicin/prediction/15_tb_rifampicin_MIC_large_minbin_POM_loso/logs/15_tb_rifampicin_MIC_large_minbin_POM_loso.err
#SBATCH --output=/nfs/research/jlees/jacqueline/thesis_results/gwas_tb_rifampicin/prediction/15_tb_rifampicin_MIC_large_minbin_POM_loso/logs/15_tb_rifampicin_MIC_large_minbin_POM_loso.out
