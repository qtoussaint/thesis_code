...
#SBATCH --error=/nfs/research/jlees/jacqueline/thesis_results/gwas_spn_penicillin/prediction/03_spn_penicillin_continuous_continuous_random/logs/03_spn_penicillin_continuous_continuous_random_%j.err
#SBATCH --output=/nfs/research/jlees/jacqueline/thesis_results/gwas_spn_penicillin/prediction/03_spn_penicillin_continuous_continuous_random/logs/03_spn_penicillin_continuous_continuous_random_%j.out
