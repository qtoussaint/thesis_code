...
#SBATCH --error=/nfs/research/jlees/jacqueline/thesis_results/gwas_spn_penicillin/prediction/11_spn_penicillin_MIC_large_minbin_POM_loso/logs/11_spn_penicillin_MIC_large_minbin_POM_loso.err
#SBATCH --output=/nfs/research/jlees/jacqueline/thesis_results/gwas_spn_penicillin/prediction/11_spn_penicillin_MIC_large_minbin_POM_loso/logs/11_spn_penicillin_MIC_large_minbin_POM_loso.out
