// Ridge (Gaussian, sigma=5) prior on per-cutpoint variant effects, with raw
// genotype X. Derived from final_no_horseshoe_no_centering_PPOM.stan:
// identical architecture (alpha_mean, fixed cutpoints from
// log2(mic_breakpoints), lineage handling, raw genotype matrix) except the
// prior on beta_variant_raw is normal(0, 5) instead of normal(0, 1). Adds
