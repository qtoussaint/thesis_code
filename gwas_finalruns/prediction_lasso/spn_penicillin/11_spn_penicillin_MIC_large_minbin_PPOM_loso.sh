#!/usr/bin/env bash
#SBATCH --job-name=spnpen_11_PPOM_pred_loso_lasso
#SBATCH --nodes=1
#SBATCH --cpus-per-task=48
#SBATCH --mem=650G
#SBATCH --time=12:00:00
#SBATCH --error=/nfs/research/jlees/jacqueline/thesis_results/gwas_spn_penicillin/prediction_lasso/11_spn_penicillin_MIC_large_minbin_PPOM_loso/logs/11_spn_penicillin_MIC_large_minbin_PPOM_loso_%j.err
#SBATCH --output=/nfs/research/jlees/jacqueline/thesis_results/gwas_spn_penicillin/prediction_lasso/11_spn_penicillin_MIC_large_minbin_PPOM_loso/logs/11_spn_penicillin_MIC_large_minbin_PPOM_loso_%j.out
...
mkdir -p /nfs/research/jlees/jacqueline/thesis_results/gwas_spn_penicillin/prediction_lasso/11_spn_penicillin_MIC_large_minbin_PPOM_loso/logs
...
OUTPUT_DIR="--output_directory /nfs/research/jlees/jacqueline/thesis_results/gwas_spn_penicillin/prediction_lasso/11_spn_penicillin_MIC_large_minbin_PPOM_loso"
THREADS="--threads 48"
...
NORATE="--norate"
TRUE_PHENOTYPES="--true_phenotypes /nfs/research/jlees/jacqueline/thesis_results/gwas_datasets/prediction/11_spn_penicillin_MIC_large_minbin_loso/11_spn_penicillin_MIC_large_minbin_loso_test_phenotypes.csv"
