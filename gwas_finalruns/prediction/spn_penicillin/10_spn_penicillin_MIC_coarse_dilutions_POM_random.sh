...
#SBATCH --error=/nfs/research/jlees/jacqueline/thesis_results/gwas_spn_penicillin/prediction/10_spn_penicillin_MIC_coarse_dilutions_POM_random/logs/10_spn_penicillin_MIC_coarse_dilutions_POM_random_%j.err
#SBATCH --output=/nfs/research/jlees/jacqueline/thesis_results/gwas_spn_penicillin/prediction/10_spn_penicillin_MIC_coarse_dilutions_POM_random/logs/10_spn_penicillin_MIC_coarse_dilutions_POM_random_%j.out
