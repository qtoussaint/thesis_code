#!/usr/bin/env bash
#SBATCH --job-name=tbrif_08_PPOM_pred_loso
#SBATCH --nodes=1
#SBATCH --cpus-per-task=48
#SBATCH --mem=800G
#SBATCH --time=24:00:00
#SBATCH --error=/nfs/research/jlees/jacqueline/thesis_results/gwas_tb_rifampicin/prediction/08_tb_rifampicin_MIC_PPOM_loso/logs/08_tb_rifampicin_MIC_PPOM_loso_%j.err
#SBATCH --output=/nfs/research/jlees/jacqueline/thesis_results/gwas_tb_rifampicin/prediction/08_tb_rifampicin_MIC_PPOM_loso/logs/08_tb_rifampicin_MIC_PPOM_loso_%j.out
...
mkdir -p /nfs/research/jlees/jacqueline/thesis_results/gwas_tb_rifampicin/prediction/08_tb_rifampicin_MIC_PPOM_loso/logs
...
OUTPUT_DIR="--output_directory /nfs/research/jlees/jacqueline/thesis_results/gwas_tb_rifampicin/prediction/08_tb_rifampicin_MIC_PPOM_loso"
THREADS="--threads 48"
