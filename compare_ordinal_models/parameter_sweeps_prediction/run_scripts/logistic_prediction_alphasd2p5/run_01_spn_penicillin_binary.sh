...
#SBATCH --job-name=01_logistic_prediction_alphasd2p5_pred
#SBATCH --nodes=1
#SBATCH --cpus-per-task=48
#SBATCH --mem=600G
#SBATCH --time=06:00:00
#SBATCH --error=/nfs/research/jlees/jacqueline/thesis_results/compare_ordinal_models/parameter_sweeps_prediction/runs/logistic_prediction_alphasd2p5/01_spn_penicillin_binary/logs/01_spn_penicillin_binary.err
#SBATCH --output=/nfs/research/jlees/jacqueline/thesis_results/compare_ordinal_models/parameter_sweeps_prediction/runs/logistic_prediction_alphasd2p5/01_spn_penicillin_binary/logs/01_spn_penicillin_binary.out
...
STAN_MODEL="--stan_model /nfs/research/jlees/jacqueline/thesis_code/compare_ordinal_models/parameter_sweeps_prediction/stan_models/logistic_prediction_alphasd2p5.stan"
ANALYSIS_TYPE="--analysis_type prediction"
ANALYSIS_NICKNAME="--analysis_nickname 01_logistic_prediction_alphasd2p5"
OUTPUT_DIR="--output_directory /nfs/research/jlees/jacqueline/thesis_results/compare_ordinal_models/parameter_sweeps_prediction/runs/logistic_prediction_alphasd2p5/01_spn_penicillin_binary"
THREADS="--threads 48"
...
mkdir -p /nfs/research/jlees/jacqueline/thesis_results/compare_ordinal_models/parameter_sweeps_prediction/runs/logistic_prediction_alphasd2p5/01_spn_penicillin_binary/logs
