#!/usr/bin/env bash
#SBATCH --job-name=tbrif_15_POM_infe
#SBATCH --nodes=1
#SBATCH --cpus-per-task=48
#SBATCH --mem=800G
#SBATCH --time=24:00:00
#SBATCH --error=/nfs/research/jlees/jacqueline/thesis_results/gwas_tb_rifampicin/inference/15_tb_rifampicin_MIC_large_minbin_POM/logs/15_tb_rifampicin_MIC_large_minbin_POM_%j.err
#SBATCH --output=/nfs/research/jlees/jacqueline/thesis_results/gwas_tb_rifampicin/inference/15_tb_rifampicin_MIC_large_minbin_POM/logs/15_tb_rifampicin_MIC_large_minbin_POM_%j.out
...
mkdir -p /nfs/research/jlees/jacqueline/thesis_results/gwas_tb_rifampicin/inference/15_tb_rifampicin_MIC_large_minbin_POM/logs
...
OUTPUT_DIR="--output_directory /nfs/research/jlees/jacqueline/thesis_results/gwas_tb_rifampicin/inference/15_tb_rifampicin_MIC_large_minbin_POM"
THREADS="--threads 48"
