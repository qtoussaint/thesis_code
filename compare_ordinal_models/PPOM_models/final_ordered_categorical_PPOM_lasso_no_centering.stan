// Lasso (Laplace) variant of final_ordered_categorical_PPOM, using raw
// genotype X (no centering/scaling). Replaces the regularized horseshoe on
// beta_variant with a double_exponential(0, 1) prior. Architecture: fixed
// cutpoints from log2(mic_breakpoints), fixed alpha_mean anchored intercept,
// raw variant_matrix in linear predictor, deterministic-subset PPC,
// per-cutpoint heritability metrics.
