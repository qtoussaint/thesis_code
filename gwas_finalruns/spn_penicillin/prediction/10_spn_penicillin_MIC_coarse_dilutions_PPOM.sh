#!/usr/bin/env bash
#SBATCH --job-name=spnpen_10_PPOM_pred
#SBATCH --nodes=1
#SBATCH --cpus-per-task=80
#SBATCH --mem=650G
#SBATCH --time=12:00:00
#SBATCH --error=/nfs/research/jlees/jacqueline/thesis_results/gwas_spn_penicillin/prediction/10_spn_penicillin_MIC_coarse_dilutions_PPOM/logs/10_spn_penicillin_MIC_coarse_dilutions_PPOM.err
#SBATCH --output=/nfs/research/jlees/jacqueline/thesis_results/gwas_spn_penicillin/prediction/10_spn_penicillin_MIC_coarse_dilutions_PPOM/logs/10_spn_penicillin_MIC_coarse_dilutions_PPOM.out
...
mkdir -p /nfs/research/jlees/jacqueline/thesis_results/gwas_spn_penicillin/prediction/10_spn_penicillin_MIC_coarse_dilutions_PPOM/logs
...
OUTPUT_DIR="--output_directory /nfs/research/jlees/jacqueline/thesis_results/gwas_spn_penicillin/prediction/10_spn_penicillin_MIC_coarse_dilutions_PPOM"
THREADS="--threads 80"
