#!/usr/bin/env bash
#SBATCH --job-name=spntmp_13_POM_infe
#SBATCH --nodes=1
...
mkdir -p /nfs/research/jlees/jacqueline/thesis_results/gwas_spn_trimethoprim/inference/13_spn_trimethoprim_MIC_large_minbin_POM/logs
...
OUTPUT_DIR="--output_directory /nfs/research/jlees/jacqueline/thesis_results/gwas_spn_trimethoprim/inference/13_spn_trimethoprim_MIC_large_minbin_POM"
THREADS="--threads 48"
