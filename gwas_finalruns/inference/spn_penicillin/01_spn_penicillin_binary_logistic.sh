#!/usr/bin/env bash
#SBATCH --job-name=spnpen_01_logistic_infe
#SBATCH --nodes=1
...
mkdir -p /nfs/research/jlees/jacqueline/thesis_results/gwas_spn_penicillin/inference/01_spn_penicillin_binary_logistic/logs
...
OUTPUT_DIR="--output_directory /nfs/research/jlees/jacqueline/thesis_results/gwas_spn_penicillin/inference/01_spn_penicillin_binary_logistic"
THREADS="--threads 32"
