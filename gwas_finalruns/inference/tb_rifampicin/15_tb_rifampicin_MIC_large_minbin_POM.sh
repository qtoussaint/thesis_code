...
#SBATCH --error=/nfs/research/jlees/jacqueline/thesis_results/gwas_tb_rifampicin/inference/15_tb_rifampicin_MIC_large_minbin_POM/logs/15_tb_rifampicin_MIC_large_minbin_POM.err
#SBATCH --output=/nfs/research/jlees/jacqueline/thesis_results/gwas_tb_rifampicin/inference/15_tb_rifampicin_MIC_large_minbin_POM/logs/15_tb_rifampicin_MIC_large_minbin_POM.out
