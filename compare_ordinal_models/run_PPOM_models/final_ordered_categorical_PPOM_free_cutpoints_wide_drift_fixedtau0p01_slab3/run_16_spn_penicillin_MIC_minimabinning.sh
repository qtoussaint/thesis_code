...
#SBATCH --error=/nfs/research/jlees/jacqueline/thesis_results/compare_ordinal_models/final_ordered_categorical_PPOM_free_cutpoints_wide_drift_fixedtau0p01_slab3/16_spn_penicillin_MIC_minimabinning/logs/16_spn_penicillin_MIC_minimabinning.err
#SBATCH --output=/nfs/research/jlees/jacqueline/thesis_results/compare_ordinal_models/final_ordered_categorical_PPOM_free_cutpoints_wide_drift_fixedtau0p01_slab3/16_spn_penicillin_MIC_minimabinning/logs/16_spn_penicillin_MIC_minimabinning.out
...
OUTPUT_DIR="--output_directory /nfs/research/jlees/jacqueline/thesis_results/compare_ordinal_models/final_ordered_categorical_PPOM_free_cutpoints_wide_drift_fixedtau0p01_slab3/16_spn_penicillin_MIC_minimabinning"
THREADS="--threads 80"
...
mkdir -p /nfs/research/jlees/jacqueline/thesis_results/compare_ordinal_models/final_ordered_categorical_PPOM_free_cutpoints_wide_drift_fixedtau0p01_slab3/16_spn_penicillin_MIC_minimabinning/logs
