#!/usr/bin/env bash
#SBATCH --job-name=spnpen_02_PPOM_pred_random
#SBATCH --nodes=1
#SBATCH --cpus-per-task=48
#SBATCH --mem=650G
#SBATCH --time=12:00:00
#SBATCH --error=/nfs/research/jlees/jacqueline/thesis_results/gwas_spn_penicillin/prediction/02_spn_penicillin_MIC_PPOM_random/logs/02_spn_penicillin_MIC_PPOM_random_%j.err
#SBATCH --output=/nfs/research/jlees/jacqueline/thesis_results/gwas_spn_penicillin/prediction/02_spn_penicillin_MIC_PPOM_random/logs/02_spn_penicillin_MIC_PPOM_random_%j.out
...
mkdir -p /nfs/research/jlees/jacqueline/thesis_results/gwas_spn_penicillin/prediction/02_spn_penicillin_MIC_PPOM_random/logs
...
OUTPUT_DIR="--output_directory /nfs/research/jlees/jacqueline/thesis_results/gwas_spn_penicillin/prediction/02_spn_penicillin_MIC_PPOM_random"
THREADS="--threads 48"
