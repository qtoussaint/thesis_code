...
// final_ordered_categorical_PPOM_free_cutpoints_wide_drift_ridge_estscale_ncp_no_centering.stan
...
transformed parameters {
  matrix[V, K-1] beta_variant_raw = z_variant * sigma_beta_variant;
