#!/usr/bin/env bash
#SBATCH --job-name=spnpen_10_POM_infe
#SBATCH --nodes=1
#SBATCH --cpus-per-task=48
#SBATCH --mem=650G
#SBATCH --time=12:00:00
#SBATCH --error=/nfs/research/jlees/jacqueline/thesis_results/gwas_spn_penicillin/inference/10_spn_penicillin_MIC_coarse_dilutions_POM/logs/10_spn_penicillin_MIC_coarse_dilutions_POM_%j.err
#SBATCH --output=/nfs/research/jlees/jacqueline/thesis_results/gwas_spn_penicillin/inference/10_spn_penicillin_MIC_coarse_dilutions_POM/logs/10_spn_penicillin_MIC_coarse_dilutions_POM_%j.out
...
mkdir -p /nfs/research/jlees/jacqueline/thesis_results/gwas_spn_penicillin/inference/10_spn_penicillin_MIC_coarse_dilutions_POM/logs
...
OUTPUT_DIR="--output_directory /nfs/research/jlees/jacqueline/thesis_results/gwas_spn_penicillin/inference/10_spn_penicillin_MIC_coarse_dilutions_POM"
THREADS="--threads 48"
