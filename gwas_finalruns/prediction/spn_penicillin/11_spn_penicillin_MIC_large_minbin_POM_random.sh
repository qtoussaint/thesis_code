#!/usr/bin/env bash
#SBATCH --job-name=spnpen_11_POM_pred_random
#SBATCH --nodes=1
...
mkdir -p /nfs/research/jlees/jacqueline/thesis_results/gwas_spn_penicillin/prediction/11_spn_penicillin_MIC_large_minbin_POM_random/logs
...
OUTPUT_DIR="--output_directory /nfs/research/jlees/jacqueline/thesis_results/gwas_spn_penicillin/prediction/11_spn_penicillin_MIC_large_minbin_POM_random"
THREADS="--threads 48"
