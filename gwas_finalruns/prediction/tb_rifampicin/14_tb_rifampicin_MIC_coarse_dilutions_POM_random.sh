...
#SBATCH --error=/nfs/research/jlees/jacqueline/thesis_results/gwas_tb_rifampicin/prediction/14_tb_rifampicin_MIC_coarse_dilutions_POM_random/logs/14_tb_rifampicin_MIC_coarse_dilutions_POM_random.err
#SBATCH --output=/nfs/research/jlees/jacqueline/thesis_results/gwas_tb_rifampicin/prediction/14_tb_rifampicin_MIC_coarse_dilutions_POM_random/logs/14_tb_rifampicin_MIC_coarse_dilutions_POM_random.out
