#!/usr/bin/env bash
#SBATCH --job-name=kEF10_npr
#SBATCH --nodes=1
#SBATCH --cpus-per-task=32
#SBATCH --mem=250G
#SBATCH --time=24:00:00
#SBATCH --error=/nfs/research/jlees/jacqueline/thesis_results/gwas_klebsiella_homoplasic/inference/kleb_homoplasic_EF10_H09_continuous_nopruning/logs/kleb_homoplasic_EF10_H09_continuous_nopruning_%j.err
#SBATCH --output=/nfs/research/jlees/jacqueline/thesis_results/gwas_klebsiella_homoplasic/inference/kleb_homoplasic_EF10_H09_continuous_nopruning/logs/kleb_homoplasic_EF10_H09_continuous_nopruning_%j.out
...
mkdir -p /nfs/research/jlees/jacqueline/thesis_results/gwas_klebsiella_homoplasic/inference/kleb_homoplasic_EF10_H09_continuous_nopruning/logs

RSCRIPT_PATH="/nfs/research/jlees/jacqueline/gwas_workflow/code/gwas_workflow/inst/scripts/run_pipeline.R"

DATA="--data /nfs/research/jlees/jacqueline/thesis_results/gwas_datasets/inference/kleb_homoplasic_EF10_H09/kleb_homoplasic_EF10_H09.json"
...
ANALYSIS_NICKNAME="--analysis_nickname kleb_homoplasic_EF10_H09_continuous_nopruning"
OUTPUT_DIR="--output_directory /nfs/research/jlees/jacqueline/thesis_results/gwas_klebsiella_homoplasic/inference/kleb_homoplasic_EF10_H09_continuous_nopruning"
THREADS="--threads 32"
...
PHANDANGO="--phandango /nfs/research/jlees/jacqueline/thesis_results/gwas_datasets/inference/kleb_homoplasic_EF10_H09/kleb_homoplasic_EF10_H09_variant_index.csv"
