...
#SBATCH --job-name=freeCutsS50_02_spn_pen
#SBATCH --nodes=1
#SBATCH --cpus-per-task=48
#SBATCH --mem=850G
#SBATCH --time=48:00:00
#SBATCH --error=/nfs/research/jlees/jacqueline/thesis_results/compare_ordinal_models/final_ordered_categorical_PPOM_free_cutpoints_slab50/02_spn_penicillin_MIC/logs/02_spn_penicillin_MIC.err
#SBATCH --output=/nfs/research/jlees/jacqueline/thesis_results/compare_ordinal_models/final_ordered_categorical_PPOM_free_cutpoints_slab50/02_spn_penicillin_MIC/logs/02_spn_penicillin_MIC.out
...
ANALYSIS_NICKNAME="--analysis_nickname 02_spn_penicillin_MIC_freeCutsS50PPOM"
OUTPUT_DIR="--output_directory /nfs/research/jlees/jacqueline/thesis_results/compare_ordinal_models/final_ordered_categorical_PPOM_free_cutpoints_slab50/02_spn_penicillin_MIC"
THREADS="--threads 48"
...
mkdir -p /nfs/research/jlees/jacqueline/thesis_results/compare_ordinal_models/final_ordered_categorical_PPOM_free_cutpoints_slab50/02_spn_penicillin_MIC/logs
