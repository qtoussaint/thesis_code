// Ridge (Gaussian, sigma=5) variant of final_ordered_categorical_PPOM_free_cutpoints,
// using raw genotype X (no centering/scaling). Replaces the regularized
// horseshoe on beta_variant with a normal(0, 5) prior. Architecture:
// estimated cutpoints under tight Gaussian prior around cutpoint_prior_mean,
// no alpha, raw variant_matrix in linear predictor, deterministic-subset PPC,
