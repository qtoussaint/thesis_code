...
#SBATCH --job-name=freeCutsWDT5S50_16_spn_pen_minabin
#SBATCH --nodes=1
#SBATCH --cpus-per-task=8
#SBATCH --mem=150G
#SBATCH --time=5:00:00
#SBATCH --error=/nfs/research/jlees/jacqueline/thesis_results/compare_ordinal_models/final_ordered_categorical_PPOM_free_cutpoints_wide_drift_tau5_slab50/16_spn_penicillin_MIC_minimabinning/logs/16_spn_penicillin_MIC_minimabinning.err
#SBATCH --output=/nfs/research/jlees/jacqueline/thesis_results/compare_ordinal_models/final_ordered_categorical_PPOM_free_cutpoints_wide_drift_tau5_slab50/16_spn_penicillin_MIC_minimabinning/logs/16_spn_penicillin_MIC_minimabinning.out
...
ANALYSIS_NICKNAME="--analysis_nickname 16_spn_penicillin_MIC_minimabinning_freeCutsWDT5S50PPOM"
OUTPUT_DIR="--output_directory /nfs/research/jlees/jacqueline/thesis_results/compare_ordinal_models/final_ordered_categorical_PPOM_free_cutpoints_wide_drift_tau5_slab50/16_spn_penicillin_MIC_minimabinning"
THREADS="--threads 48"
...
mkdir -p /nfs/research/jlees/jacqueline/thesis_results/compare_ordinal_models/final_ordered_categorical_PPOM_free_cutpoints_wide_drift_tau5_slab50/16_spn_penicillin_MIC_minimabinning/logs
