#!/usr/bin/env bash
#SBATCH --job-name=tbrif_14_POM_pred_random_lasso
#SBATCH --nodes=1
#SBATCH --cpus-per-task=48
#SBATCH --mem=800G
#SBATCH --time=24:00:00
#SBATCH --error=/nfs/research/jlees/jacqueline/thesis_results/gwas_tb_rifampicin/prediction_lasso/14_tb_rifampicin_MIC_coarse_dilutions_POM_random/logs/14_tb_rifampicin_MIC_coarse_dilutions_POM_random_%j.err
#SBATCH --output=/nfs/research/jlees/jacqueline/thesis_results/gwas_tb_rifampicin/prediction_lasso/14_tb_rifampicin_MIC_coarse_dilutions_POM_random/logs/14_tb_rifampicin_MIC_coarse_dilutions_POM_random_%j.out
...
mkdir -p /nfs/research/jlees/jacqueline/thesis_results/gwas_tb_rifampicin/prediction_lasso/14_tb_rifampicin_MIC_coarse_dilutions_POM_random/logs
...
ANALYSIS_NICKNAME="--analysis_nickname 14_tb_rifampicin_MIC_coarse_dilutions_POM_random"
OUTPUT_DIR="--output_directory /nfs/research/jlees/jacqueline/thesis_results/gwas_tb_rifampicin/prediction_lasso/14_tb_rifampicin_MIC_coarse_dilutions_POM_random"
THREADS="--threads 48"
