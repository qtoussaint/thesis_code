// Ridge (Gaussian, sigma=5) variant of paper_model_PPOM, using centered+scaled
// X_std. Keeps the normal(0, 5) prior on beta_variant_std AND swaps raw
// variant_matrix for centered+scaled X_std in the linear predictor.
// Architecture otherwise: cutpoints estimated as parameters with N(log2(MIC),
// 0.5) prior, scalar lineage-level heritability, no alpha_mean.
