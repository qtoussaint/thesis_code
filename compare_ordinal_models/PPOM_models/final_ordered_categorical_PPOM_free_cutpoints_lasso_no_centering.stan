// Lasso (Laplace) variant of final_ordered_categorical_PPOM_free_cutpoints,
...
// Architecture: estimated cutpoints under tight Gaussian prior around
// cutpoint_prior_mean, no alpha, raw variant_matrix in linear predictor,
// deterministic-subset PPC, per-cutpoint heritability metrics.
