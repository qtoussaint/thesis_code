#!/usr/bin/env bash
#SBATCH --job-name=tbrif_08_POM_pred_random_lasso
#SBATCH --nodes=1
#SBATCH --cpus-per-task=48
#SBATCH --mem=800G
#SBATCH --time=24:00:00
#SBATCH --error=/nfs/research/jlees/jacqueline/thesis_results/gwas_tb_rifampicin/prediction_lasso/08_tb_rifampicin_MIC_POM_random/logs/08_tb_rifampicin_MIC_POM_random_%j.err
#SBATCH --output=/nfs/research/jlees/jacqueline/thesis_results/gwas_tb_rifampicin/prediction_lasso/08_tb_rifampicin_MIC_POM_random/logs/08_tb_rifampicin_MIC_POM_random_%j.out
...
mkdir -p /nfs/research/jlees/jacqueline/thesis_results/gwas_tb_rifampicin/prediction_lasso/08_tb_rifampicin_MIC_POM_random/logs
...
OUTPUT_DIR="--output_directory /nfs/research/jlees/jacqueline/thesis_results/gwas_tb_rifampicin/prediction_lasso/08_tb_rifampicin_MIC_POM_random"
THREADS="--threads 48"
