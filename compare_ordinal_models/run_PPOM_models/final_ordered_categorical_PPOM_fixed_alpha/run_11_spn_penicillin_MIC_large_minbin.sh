...
ANALYSIS_NICKNAME="--analysis_nickname 11_spn_penicillin_MIC_large_minbin_fixedAlphaPPOM"
OUTPUT_DIR="--output_directory /nfs/research/jlees/jacqueline/thesis_results/compare_ordinal_models/final_ordered_categorical_PPOM_fixed_alpha/11_spn_penicillin_MIC_large_minbin"
THREADS="--threads 48"
...
mkdir -p /nfs/research/jlees/jacqueline/thesis_results/compare_ordinal_models/final_ordered_categorical_PPOM_fixed_alpha/11_spn_penicillin_MIC_large_minbin/logs
