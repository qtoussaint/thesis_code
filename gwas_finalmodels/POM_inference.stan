...
// A regularized-horseshoe is used for variant selection within beta_variant (Piironen & Vehtari 2017, eq. 3.12).

// Lineage clusters/subclusters are used to absorb population structure.
