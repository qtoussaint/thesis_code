#!/usr/bin/env bash
#SBATCH --job-name=tbrif_08_PPOM_infe
#SBATCH --nodes=1
#SBATCH --cpus-per-task=48
#SBATCH --mem=800G
#SBATCH --time=24:00:00
#SBATCH --error=/nfs/research/jlees/jacqueline/thesis_results/gwas_tb_rifampicin/inference/08_tb_rifampicin_MIC_PPOM/logs/08_tb_rifampicin_MIC_PPOM.err
#SBATCH --output=/nfs/research/jlees/jacqueline/thesis_results/gwas_tb_rifampicin/inference/08_tb_rifampicin_MIC_PPOM/logs/08_tb_rifampicin_MIC_PPOM.out
...
mkdir -p /nfs/research/jlees/jacqueline/thesis_results/gwas_tb_rifampicin/inference/08_tb_rifampicin_MIC_PPOM/logs
...
OUTPUT_DIR="--output_directory /nfs/research/jlees/jacqueline/thesis_results/gwas_tb_rifampicin/inference/08_tb_rifampicin_MIC_PPOM"
THREADS="--threads 48"
