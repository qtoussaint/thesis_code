#!/usr/bin/env bash
#SBATCH --job-name=tbrif_07_lineage_infe
#SBATCH --nodes=1
#SBATCH --cpus-per-task=48
#SBATCH --mem=400G
#SBATCH --time=36:00:00
#SBATCH --error=/nfs/research/jlees/jacqueline/thesis_results/compare_lineage_subclusters/07_tb_rifampicin_binary_logistic_lineage/logs/07_tb_rifampicin_binary_logistic_lineage_%j.err
#SBATCH --output=/nfs/research/jlees/jacqueline/thesis_results/compare_lineage_subclusters/07_tb_rifampicin_binary_logistic_lineage/logs/07_tb_rifampicin_binary_logistic_lineage_%j.out

#################################################################################
#
# Arm B of the population-structure comparison: lineage clusters only.
#
...
mkdir -p /nfs/research/jlees/jacqueline/thesis_results/compare_lineage_subclusters/07_tb_rifampicin_binary_logistic_lineage/logs
...
STAN_MODEL="--stan_model /nfs/research/jlees/jacqueline/thesis_code/compare_lineage_subclusters/models/logistic_lineage_inference.stan"
ANALYSIS_TYPE="--analysis_type inference"
ANALYSIS_NICKNAME="--analysis_nickname 07_tb_rifampicin_binary_logistic_lineage"
OUTPUT_DIR="--output_directory /nfs/research/jlees/jacqueline/thesis_results/compare_lineage_subclusters/07_tb_rifampicin_binary_logistic_lineage"
THREADS="--threads 48"
