...
#SBATCH --error=/nfs/research/jlees/jacqueline/thesis_results/gwas_spn_penicillin/inference/10_spn_penicillin_MIC_coarse_dilutions_POM/logs/10_spn_penicillin_MIC_coarse_dilutions_POM.err
#SBATCH --output=/nfs/research/jlees/jacqueline/thesis_results/gwas_spn_penicillin/inference/10_spn_penicillin_MIC_coarse_dilutions_POM/logs/10_spn_penicillin_MIC_coarse_dilutions_POM.out
