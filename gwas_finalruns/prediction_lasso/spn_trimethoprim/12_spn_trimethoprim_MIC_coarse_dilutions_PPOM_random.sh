#!/usr/bin/env bash
#SBATCH --job-name=spntmp_12_PPOM_pred_random_lasso
#SBATCH --nodes=1
#SBATCH --cpus-per-task=48
#SBATCH --mem=650G
#SBATCH --time=12:00:00
#SBATCH --error=/nfs/research/jlees/jacqueline/thesis_results/gwas_spn_trimethoprim/prediction_lasso/12_spn_trimethoprim_MIC_coarse_dilutions_PPOM_random/logs/12_spn_trimethoprim_MIC_coarse_dilutions_PPOM_random_%j.err
#SBATCH --output=/nfs/research/jlees/jacqueline/thesis_results/gwas_spn_trimethoprim/prediction_lasso/12_spn_trimethoprim_MIC_coarse_dilutions_PPOM_random/logs/12_spn_trimethoprim_MIC_coarse_dilutions_PPOM_random_%j.out
...
mkdir -p /nfs/research/jlees/jacqueline/thesis_results/gwas_spn_trimethoprim/prediction_lasso/12_spn_trimethoprim_MIC_coarse_dilutions_PPOM_random/logs
...
ANALYSIS_NICKNAME="--analysis_nickname 12_spn_trimethoprim_MIC_coarse_dilutions_PPOM_random"
OUTPUT_DIR="--output_directory /nfs/research/jlees/jacqueline/thesis_results/gwas_spn_trimethoprim/prediction_lasso/12_spn_trimethoprim_MIC_coarse_dilutions_PPOM_random"
THREADS="--threads 48"
