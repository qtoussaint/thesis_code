...
// final_no_horseshoe_no_centering_flexiblecutpoints.stan.
// Relaxes proportional odds ONLY for variant effects (beta_variant_raw is now a
// V x (K-1) matrix). Sublineage effects remain proportional. No intercept — location
// absorbed into estimated cutpoints. PPOM coding follows paper_model_PPOM.stan.
...
model {
  ...
  to_vector(beta_variant_raw) ~ normal(0, 1);
