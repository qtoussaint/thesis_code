...
#SBATCH --error=/nfs/research/jlees/jacqueline/thesis_results/gwas_spn_penicillin/inference/11_spn_penicillin_MIC_large_minbin_POM/logs/11_spn_penicillin_MIC_large_minbin_POM_%j.err
#SBATCH --output=/nfs/research/jlees/jacqueline/thesis_results/gwas_spn_penicillin/inference/11_spn_penicillin_MIC_large_minbin_POM/logs/11_spn_penicillin_MIC_large_minbin_POM_%j.out
