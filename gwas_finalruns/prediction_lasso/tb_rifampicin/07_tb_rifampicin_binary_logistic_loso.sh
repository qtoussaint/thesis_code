#!/usr/bin/env bash
#SBATCH --job-name=tbrif_07_logistic_pred_loso_lasso
#SBATCH --nodes=1
#SBATCH --cpus-per-task=48
#SBATCH --mem=400G
#SBATCH --time=12:00:00
#SBATCH --error=/nfs/research/jlees/jacqueline/thesis_results/gwas_tb_rifampicin/prediction_lasso/07_tb_rifampicin_binary_logistic_loso/logs/07_tb_rifampicin_binary_logistic_loso_%j.err
#SBATCH --output=/nfs/research/jlees/jacqueline/thesis_results/gwas_tb_rifampicin/prediction_lasso/07_tb_rifampicin_binary_logistic_loso/logs/07_tb_rifampicin_binary_logistic_loso_%j.out
...
mkdir -p /nfs/research/jlees/jacqueline/thesis_results/gwas_tb_rifampicin/prediction_lasso/07_tb_rifampicin_binary_logistic_loso/logs
...
OUTPUT_DIR="--output_directory /nfs/research/jlees/jacqueline/thesis_results/gwas_tb_rifampicin/prediction_lasso/07_tb_rifampicin_binary_logistic_loso"
THREADS="--threads 48"
