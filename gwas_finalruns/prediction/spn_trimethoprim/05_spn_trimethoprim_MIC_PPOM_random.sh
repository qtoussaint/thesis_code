...
#SBATCH --error=/nfs/research/jlees/jacqueline/thesis_results/gwas_spn_trimethoprim/prediction/05_spn_trimethoprim_MIC_PPOM_random/logs/05_spn_trimethoprim_MIC_PPOM_random_%j.err
#SBATCH --output=/nfs/research/jlees/jacqueline/thesis_results/gwas_spn_trimethoprim/prediction/05_spn_trimethoprim_MIC_PPOM_random/logs/05_spn_trimethoprim_MIC_PPOM_random_%j.out
