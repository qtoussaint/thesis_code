// AUTO-GENERATED alpha-SD sweep prediction model: continuous, alpha_prior_sd = 5.
// Produced by parameter_sweeps_prediction/generate_alpha_prediction_stan.R
// from gwas_finalmodels/continuous_prediction.stan; do not edit by hand.
