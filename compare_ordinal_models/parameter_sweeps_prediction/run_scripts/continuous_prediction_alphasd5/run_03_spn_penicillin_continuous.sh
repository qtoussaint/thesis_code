...
#SBATCH --job-name=03_continuous_prediction_alphasd5_pred
#SBATCH --nodes=1
#SBATCH --cpus-per-task=48
#SBATCH --mem=600G
#SBATCH --time=06:00:00
#SBATCH --error=/nfs/research/jlees/jacqueline/thesis_results/compare_ordinal_models/parameter_sweeps_prediction/runs/continuous_prediction_alphasd5/03_spn_penicillin_continuous/logs/03_spn_penicillin_continuous.err
#SBATCH --output=/nfs/research/jlees/jacqueline/thesis_results/compare_ordinal_models/parameter_sweeps_prediction/runs/continuous_prediction_alphasd5/03_spn_penicillin_continuous/logs/03_spn_penicillin_continuous.out
...
STAN_MODEL="--stan_model /nfs/research/jlees/jacqueline/thesis_code/compare_ordinal_models/parameter_sweeps_prediction/stan_models/continuous_prediction_alphasd5.stan"
ANALYSIS_TYPE="--analysis_type prediction"
ANALYSIS_NICKNAME="--analysis_nickname 03_continuous_prediction_alphasd5"
OUTPUT_DIR="--output_directory /nfs/research/jlees/jacqueline/thesis_results/compare_ordinal_models/parameter_sweeps_prediction/runs/continuous_prediction_alphasd5/03_spn_penicillin_continuous"
THREADS="--threads 48"
...
mkdir -p /nfs/research/jlees/jacqueline/thesis_results/compare_ordinal_models/parameter_sweeps_prediction/runs/continuous_prediction_alphasd5/03_spn_penicillin_continuous/logs
