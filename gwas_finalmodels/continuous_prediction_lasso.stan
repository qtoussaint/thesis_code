// Lasso (Laplace) version of continuous_prediction.stan -- continuous (log2-MIC)
// prediction model, training/test split counterpart of continuous_inference.stan.
//
...
// predicted_phenotype).
//
// Differs from continuous_prediction.stan in exactly one place: the regularized
