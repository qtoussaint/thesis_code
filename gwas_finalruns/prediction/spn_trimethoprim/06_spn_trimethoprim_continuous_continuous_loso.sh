#!/usr/bin/env bash
#SBATCH --job-name=spntmp_06_continuous_pred_loso
#SBATCH --nodes=1
...
mkdir -p /nfs/research/jlees/jacqueline/thesis_results/gwas_spn_trimethoprim/prediction/06_spn_trimethoprim_continuous_continuous_loso/logs
...
OUTPUT_DIR="--output_directory /nfs/research/jlees/jacqueline/thesis_results/gwas_spn_trimethoprim/prediction/06_spn_trimethoprim_continuous_continuous_loso"
THREADS="--threads 32"
