#!/usr/bin/env bash
#SBATCH --job-name=spnpen_02_POM_pred_random_lasso
#SBATCH --nodes=1
#SBATCH --cpus-per-task=48
#SBATCH --mem=650G
#SBATCH --time=12:00:00
#SBATCH --error=/nfs/research/jlees/jacqueline/thesis_results/gwas_spn_penicillin/prediction_lasso/02_spn_penicillin_MIC_POM_random/logs/02_spn_penicillin_MIC_POM_random_%j.err
#SBATCH --output=/nfs/research/jlees/jacqueline/thesis_results/gwas_spn_penicillin/prediction_lasso/02_spn_penicillin_MIC_POM_random/logs/02_spn_penicillin_MIC_POM_random_%j.out
...
mkdir -p /nfs/research/jlees/jacqueline/thesis_results/gwas_spn_penicillin/prediction_lasso/02_spn_penicillin_MIC_POM_random/logs
...
ANALYSIS_NICKNAME="--analysis_nickname 02_spn_penicillin_MIC_POM_random"
OUTPUT_DIR="--output_directory /nfs/research/jlees/jacqueline/thesis_results/gwas_spn_penicillin/prediction_lasso/02_spn_penicillin_MIC_POM_random"
THREADS="--threads 48"
