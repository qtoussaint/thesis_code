...
#SBATCH --job-name=poolKPPOM_10_spn_pen_coarse
#SBATCH --nodes=1
#SBATCH --cpus-per-task=48
#SBATCH --mem=400G
#SBATCH --time=5:00:00
#SBATCH --error=/nfs/research/jlees/jacqueline/thesis_results/compare_ordinal_models/final_ordered_categorical_PPOM_poolk/10_spn_penicillin_MIC_coarse_dilutions/logs/10_spn_penicillin_MIC_coarse_dilutions.err
#SBATCH --output=/nfs/research/jlees/jacqueline/thesis_results/compare_ordinal_models/final_ordered_categorical_PPOM_poolk/10_spn_penicillin_MIC_coarse_dilutions/logs/10_spn_penicillin_MIC_coarse_dilutions.out
...
STAN_MODEL="--stan_model /nfs/research/jlees/jacqueline/thesis_code/compare_ordinal_models/PPOM_models/final_ordered_categorical_PPOM_poolk.stan"
ANALYSIS_TYPE="--analysis_type inference"
ANALYSIS_NICKNAME="--analysis_nickname 10_spn_penicillin_MIC_coarse_dilutions_poolKPPOM"
OUTPUT_DIR="--output_directory /nfs/research/jlees/jacqueline/thesis_results/compare_ordinal_models/final_ordered_categorical_PPOM_poolk/10_spn_penicillin_MIC_coarse_dilutions"
THREADS="--threads 48"
...
mkdir -p /nfs/research/jlees/jacqueline/thesis_results/compare_ordinal_models/final_ordered_categorical_PPOM_poolk/10_spn_penicillin_MIC_coarse_dilutions/logs
