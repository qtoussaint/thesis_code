...
#SBATCH --error=/nfs/research/jlees/jacqueline/thesis_results/gwas_spn_penicillin/prediction/02_spn_penicillin_MIC_PPOM_random/logs/02_spn_penicillin_MIC_PPOM_random.err
#SBATCH --output=/nfs/research/jlees/jacqueline/thesis_results/gwas_spn_penicillin/prediction/02_spn_penicillin_MIC_PPOM_random/logs/02_spn_penicillin_MIC_PPOM_random.out
