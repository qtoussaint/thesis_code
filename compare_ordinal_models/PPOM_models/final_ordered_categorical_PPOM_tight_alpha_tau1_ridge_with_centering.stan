// Ridge (Gaussian, sigma=5) variant of final_ordered_categorical_PPOM_tight_alpha_tau1.
// Replaces the regularized horseshoe on beta_variant_std with a normal(0, 5)
// prior. Architecture is otherwise identical: fixed cutpoints at
// log2(mic_breakpoints), free alpha under data-empirical tight Gaussian prior
// anchored on p_baseline_emp, centered+scaled X_std, deterministic-subset
// PPC, per-cutpoint heritability metrics.
