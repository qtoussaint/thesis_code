#!/usr/bin/env bash
#SBATCH --job-name=spnpen_11_POM_pred_loso_lasso
#SBATCH --nodes=1
#SBATCH --cpus-per-task=48
#SBATCH --mem=650G
#SBATCH --time=12:00:00
#SBATCH --error=/nfs/research/jlees/jacqueline/thesis_results/gwas_spn_penicillin/prediction_lasso/11_spn_penicillin_MIC_large_minbin_POM_loso/logs/11_spn_penicillin_MIC_large_minbin_POM_loso_%j.err
#SBATCH --output=/nfs/research/jlees/jacqueline/thesis_results/gwas_spn_penicillin/prediction_lasso/11_spn_penicillin_MIC_large_minbin_POM_loso/logs/11_spn_penicillin_MIC_large_minbin_POM_loso_%j.out
...
mkdir -p /nfs/research/jlees/jacqueline/thesis_results/gwas_spn_penicillin/prediction_lasso/11_spn_penicillin_MIC_large_minbin_POM_loso/logs
...
ANALYSIS_NICKNAME="--analysis_nickname 11_spn_penicillin_MIC_large_minbin_POM_loso"
OUTPUT_DIR="--output_directory /nfs/research/jlees/jacqueline/thesis_results/gwas_spn_penicillin/prediction_lasso/11_spn_penicillin_MIC_large_minbin_POM_loso"
THREADS="--threads 48"
