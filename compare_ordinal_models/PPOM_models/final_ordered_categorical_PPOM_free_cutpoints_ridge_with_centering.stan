...
// Replaces the regularized horseshoe on beta_variant_std with a
// normal(0, 5) prior. Architecture is otherwise identical: estimated
// cutpoints under tight Gaussian prior around cutpoint_prior_mean, no alpha,
// centered+scaled X_std, deterministic-subset PPC, per-cutpoint heritability
// metrics.
