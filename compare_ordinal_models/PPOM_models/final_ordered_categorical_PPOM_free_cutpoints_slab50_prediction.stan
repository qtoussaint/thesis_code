...
// final_ordered_categorical_PPOM_free_cutpoints_slab50.stan.
//
// Same training/test architecture as gwas_finalmodels/PPOM_prediction.stan,
// but cutpoints are estimated (no alpha) under a tight Gaussian prior:
// slab_scale = 50, tau_0 = 1, cutpoint_prior_sd = 0.25.
