...
// final_ordered_categorical_PPOM_free_cutpoints_wide_drift_fixedtau1p5_slab5_lambda2.stan
...
transformed parameters {
  ...
  real tau        = 1.5;  // FIXED -- sets spike width [-0.1, 0.1] at 2 sigma
  real slab_scale = 5;     // caps max|beta| near ~3 (matches no-HS empirical max)
  real nu         = 4;
