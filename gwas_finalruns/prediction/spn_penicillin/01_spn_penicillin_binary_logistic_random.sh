...
#SBATCH --error=/nfs/research/jlees/jacqueline/thesis_results/gwas_spn_penicillin/prediction/01_spn_penicillin_binary_logistic_random/logs/01_spn_penicillin_binary_logistic_random_%j.err
#SBATCH --output=/nfs/research/jlees/jacqueline/thesis_results/gwas_spn_penicillin/prediction/01_spn_penicillin_binary_logistic_random/logs/01_spn_penicillin_binary_logistic_random_%j.out
