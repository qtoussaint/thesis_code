// AUTO-GENERATED alpha-SD sweep prediction model: logistic, alpha_prior_sd = 0.075.
// Produced by parameter_sweeps_prediction/generate_alpha_prediction_stan.R
// from gwas_finalmodels/logistic_prediction.stan; do not edit by hand.
