...
#SBATCH --job-name=noHSnoCentPPOM_10_spn_pen_coarse
#SBATCH --nodes=1
#SBATCH --cpus-per-task=48
#SBATCH --mem=400G
#SBATCH --time=5:00:00
#SBATCH --error=/nfs/research/jlees/jacqueline/thesis_results/compare_ordinal_models/final_no_horseshoe_no_centering_PPOM/10_spn_penicillin_MIC_coarse_dilutions/logs/10_spn_penicillin_MIC_coarse_dilutions.err
#SBATCH --output=/nfs/research/jlees/jacqueline/thesis_results/compare_ordinal_models/final_no_horseshoe_no_centering_PPOM/10_spn_penicillin_MIC_coarse_dilutions/logs/10_spn_penicillin_MIC_coarse_dilutions.out
...
ANALYSIS_NICKNAME="--analysis_nickname 10_spn_penicillin_MIC_coarse_dilutions_noHSnoCentPPOM"
OUTPUT_DIR="--output_directory /nfs/research/jlees/jacqueline/thesis_results/compare_ordinal_models/final_no_horseshoe_no_centering_PPOM/10_spn_penicillin_MIC_coarse_dilutions"
THREADS="--threads 48"
...
mkdir -p /nfs/research/jlees/jacqueline/thesis_results/compare_ordinal_models/final_no_horseshoe_no_centering_PPOM/10_spn_penicillin_MIC_coarse_dilutions/logs
