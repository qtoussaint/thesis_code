...
mkdir -p /nfs/research/jlees/jacqueline/thesis_results/gwas_spn_penicillin/prediction_lasso/18_spn_penicillin_MIC_minimabinning_unitigs_PPOM_random/logs
...
OUTPUT_DIR="--output_directory /nfs/research/jlees/jacqueline/thesis_results/gwas_spn_penicillin/prediction_lasso/18_spn_penicillin_MIC_minimabinning_unitigs_PPOM_random"
THREADS="--threads 48"
