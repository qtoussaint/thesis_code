#!/usr/bin/env bash
#SBATCH --job-name=tbrif_08_PPOM_pred_random_lasso
#SBATCH --nodes=1
#SBATCH --cpus-per-task=48
#SBATCH --mem=800G
#SBATCH --time=24:00:00
#SBATCH --error=/nfs/research/jlees/jacqueline/thesis_results/gwas_tb_rifampicin/prediction_lasso/08_tb_rifampicin_MIC_PPOM_random/logs/08_tb_rifampicin_MIC_PPOM_random_%j.err
#SBATCH --output=/nfs/research/jlees/jacqueline/thesis_results/gwas_tb_rifampicin/prediction_lasso/08_tb_rifampicin_MIC_PPOM_random/logs/08_tb_rifampicin_MIC_PPOM_random_%j.out
...
mkdir -p /nfs/research/jlees/jacqueline/thesis_results/gwas_tb_rifampicin/prediction_lasso/08_tb_rifampicin_MIC_PPOM_random/logs
...
OUTPUT_DIR="--output_directory /nfs/research/jlees/jacqueline/thesis_results/gwas_tb_rifampicin/prediction_lasso/08_tb_rifampicin_MIC_PPOM_random"
THREADS="--threads 48"
...
NORATE="--norate"
TRUE_PHENOTYPES="--true_phenotypes /nfs/research/jlees/jacqueline/thesis_results/gwas_datasets/prediction/08_tb_rifampicin_MIC/08_tb_rifampicin_MIC_test_phenotypes.csv"
