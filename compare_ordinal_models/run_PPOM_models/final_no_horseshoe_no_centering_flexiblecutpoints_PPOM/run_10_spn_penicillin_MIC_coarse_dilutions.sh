...
ANALYSIS_NICKNAME="--analysis_nickname 10_spn_penicillin_MIC_coarse_dilutions_noHSnoCentFlexPPOM"
OUTPUT_DIR="--output_directory /nfs/research/jlees/jacqueline/thesis_results/compare_ordinal_models/final_no_horseshoe_no_centering_flexiblecutpoints_PPOM/10_spn_penicillin_MIC_coarse_dilutions"
THREADS="--threads 48"
...
mkdir -p /nfs/research/jlees/jacqueline/thesis_results/compare_ordinal_models/final_no_horseshoe_no_centering_flexiblecutpoints_PPOM/10_spn_penicillin_MIC_coarse_dilutions/logs
