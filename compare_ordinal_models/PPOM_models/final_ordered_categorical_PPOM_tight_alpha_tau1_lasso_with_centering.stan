...
// double_exponential(0, 1) prior. Architecture is otherwise identical: fixed
// cutpoints at log2(mic_breakpoints), free alpha under data-empirical tight
// Gaussian prior anchored on p_baseline_emp, centered+scaled X_std,
