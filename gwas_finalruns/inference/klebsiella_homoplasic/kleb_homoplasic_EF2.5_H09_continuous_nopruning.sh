#!/usr/bin/env bash
#SBATCH --job-name=kEF2.5_npr
#SBATCH --nodes=1
#SBATCH --cpus-per-task=32
#SBATCH --mem=250G
#SBATCH --time=24:00:00
#SBATCH --error=/nfs/research/jlees/jacqueline/thesis_results/gwas_klebsiella_homoplasic/inference/kleb_homoplasic_EF2.5_H09_continuous_nopruning/logs/kleb_homoplasic_EF2.5_H09_continuous_nopruning_%j.err
#SBATCH --output=/nfs/research/jlees/jacqueline/thesis_results/gwas_klebsiella_homoplasic/inference/kleb_homoplasic_EF2.5_H09_continuous_nopruning/logs/kleb_homoplasic_EF2.5_H09_continuous_nopruning_%j.out
...
mkdir -p /nfs/research/jlees/jacqueline/thesis_results/gwas_klebsiella_homoplasic/inference/kleb_homoplasic_EF2.5_H09_continuous_nopruning/logs
...
ANALYSIS_NICKNAME="--analysis_nickname kleb_homoplasic_EF2.5_H09_continuous_nopruning"
OUTPUT_DIR="--output_directory /nfs/research/jlees/jacqueline/thesis_results/gwas_klebsiella_homoplasic/inference/kleb_homoplasic_EF2.5_H09_continuous_nopruning"
THREADS="--threads 32"
