#!/usr/bin/env bash
#SBATCH --job-name=tbrif_09_continuous_pred_random_lasso
#SBATCH --nodes=1
#SBATCH --cpus-per-task=48
#SBATCH --mem=400G
#SBATCH --time=12:00:00
#SBATCH --error=/nfs/research/jlees/jacqueline/thesis_results/gwas_tb_rifampicin/prediction_lasso/09_tb_rifampicin_continuous_continuous_random/logs/09_tb_rifampicin_continuous_continuous_random_%j.err
#SBATCH --output=/nfs/research/jlees/jacqueline/thesis_results/gwas_tb_rifampicin/prediction_lasso/09_tb_rifampicin_continuous_continuous_random/logs/09_tb_rifampicin_continuous_continuous_random_%j.out
...
mkdir -p /nfs/research/jlees/jacqueline/thesis_results/gwas_tb_rifampicin/prediction_lasso/09_tb_rifampicin_continuous_continuous_random/logs
...
OUTPUT_DIR="--output_directory /nfs/research/jlees/jacqueline/thesis_results/gwas_tb_rifampicin/prediction_lasso/09_tb_rifampicin_continuous_continuous_random"
THREADS="--threads 48"
...
PHANDANGO="--phandango /nfs/research/jlees/jacqueline/thesis_results/gwas_datasets/prediction/09_tb_rifampicin_continuous/09_tb_rifampicin_continuous_variant_index.csv"
