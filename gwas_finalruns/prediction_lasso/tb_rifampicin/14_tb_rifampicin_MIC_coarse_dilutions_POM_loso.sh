#!/usr/bin/env bash
#SBATCH --job-name=tbrif_14_POM_pred_loso_lasso
#SBATCH --nodes=1
#SBATCH --cpus-per-task=48
#SBATCH --mem=800G
#SBATCH --time=24:00:00
#SBATCH --error=/nfs/research/jlees/jacqueline/thesis_results/gwas_tb_rifampicin/prediction_lasso/14_tb_rifampicin_MIC_coarse_dilutions_POM_loso/logs/14_tb_rifampicin_MIC_coarse_dilutions_POM_loso_%j.err
#SBATCH --output=/nfs/research/jlees/jacqueline/thesis_results/gwas_tb_rifampicin/prediction_lasso/14_tb_rifampicin_MIC_coarse_dilutions_POM_loso/logs/14_tb_rifampicin_MIC_coarse_dilutions_POM_loso_%j.out
...
mkdir -p /nfs/research/jlees/jacqueline/thesis_results/gwas_tb_rifampicin/prediction_lasso/14_tb_rifampicin_MIC_coarse_dilutions_POM_loso/logs
...
OUTPUT_DIR="--output_directory /nfs/research/jlees/jacqueline/thesis_results/gwas_tb_rifampicin/prediction_lasso/14_tb_rifampicin_MIC_coarse_dilutions_POM_loso"
THREADS="--threads 48"
