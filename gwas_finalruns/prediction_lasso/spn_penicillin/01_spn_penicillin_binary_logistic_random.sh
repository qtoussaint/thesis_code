#!/usr/bin/env bash
#SBATCH --job-name=spnpen_01_logistic_pred_random_lasso
#SBATCH --nodes=1
#SBATCH --cpus-per-task=32
#SBATCH --mem=200G
#SBATCH --time=06:00:00
#SBATCH --error=/nfs/research/jlees/jacqueline/thesis_results/gwas_spn_penicillin/prediction_lasso/01_spn_penicillin_binary_logistic_random/logs/01_spn_penicillin_binary_logistic_random_%j.err
#SBATCH --output=/nfs/research/jlees/jacqueline/thesis_results/gwas_spn_penicillin/prediction_lasso/01_spn_penicillin_binary_logistic_random/logs/01_spn_penicillin_binary_logistic_random_%j.out
...
mkdir -p /nfs/research/jlees/jacqueline/thesis_results/gwas_spn_penicillin/prediction_lasso/01_spn_penicillin_binary_logistic_random/logs
...
OUTPUT_DIR="--output_directory /nfs/research/jlees/jacqueline/thesis_results/gwas_spn_penicillin/prediction_lasso/01_spn_penicillin_binary_logistic_random"
THREADS="--threads 32"
