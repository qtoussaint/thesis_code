...
#SBATCH --error=/nfs/research/jlees/jacqueline/thesis_results/gwas_spn_trimethoprim/inference/13_spn_trimethoprim_MIC_large_minbin_PPOM/logs/13_spn_trimethoprim_MIC_large_minbin_PPOM_%j.err
#SBATCH --output=/nfs/research/jlees/jacqueline/thesis_results/gwas_spn_trimethoprim/inference/13_spn_trimethoprim_MIC_large_minbin_PPOM/logs/13_spn_trimethoprim_MIC_large_minbin_PPOM_%j.out
