...
#SBATCH --error=/nfs/research/jlees/jacqueline/thesis_results/gwas_spn_penicillin/inference/11_spn_penicillin_MIC_large_minbin_PPOM/logs/11_spn_penicillin_MIC_large_minbin_PPOM.err
#SBATCH --output=/nfs/research/jlees/jacqueline/thesis_results/gwas_spn_penicillin/inference/11_spn_penicillin_MIC_large_minbin_PPOM/logs/11_spn_penicillin_MIC_large_minbin_PPOM.out
