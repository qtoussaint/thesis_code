// Partial proportional odds (PPOM) version of final_ordered_categorical_POM_fixed_alpha.stan.
...
// Retained from the fixed-alpha POM base:
//   - Fixed cutpoints at log2(mic_breakpoints)
//   - Fixed alpha = cutpoints[1] - logit(0.99)
