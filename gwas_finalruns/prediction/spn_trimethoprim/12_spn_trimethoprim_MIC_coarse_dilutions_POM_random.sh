...
#SBATCH --error=/nfs/research/jlees/jacqueline/thesis_results/gwas_spn_trimethoprim/prediction/12_spn_trimethoprim_MIC_coarse_dilutions_POM_random/logs/12_spn_trimethoprim_MIC_coarse_dilutions_POM_random.err
#SBATCH --output=/nfs/research/jlees/jacqueline/thesis_results/gwas_spn_trimethoprim/prediction/12_spn_trimethoprim_MIC_coarse_dilutions_POM_random/logs/12_spn_trimethoprim_MIC_coarse_dilutions_POM_random.out
