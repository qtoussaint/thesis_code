#!/usr/bin/env bash
#SBATCH --job-name=spnpen_02_POM_pred
#SBATCH --nodes=1
#SBATCH --cpus-per-task=80
#SBATCH --mem=650G
#SBATCH --time=12:00:00
#SBATCH --error=/nfs/research/jlees/jacqueline/thesis_results/gwas_spn_penicillin/prediction/02_spn_penicillin_MIC_POM/logs/02_spn_penicillin_MIC_POM.err
#SBATCH --output=/nfs/research/jlees/jacqueline/thesis_results/gwas_spn_penicillin/prediction/02_spn_penicillin_MIC_POM/logs/02_spn_penicillin_MIC_POM.out
...
mkdir -p /nfs/research/jlees/jacqueline/thesis_results/gwas_spn_penicillin/prediction/02_spn_penicillin_MIC_POM/logs
...
ANALYSIS_NICKNAME="--analysis_nickname 02_spn_penicillin_MIC_POM"
OUTPUT_DIR="--output_directory /nfs/research/jlees/jacqueline/thesis_results/gwas_spn_penicillin/prediction/02_spn_penicillin_MIC_POM"
THREADS="--threads 80"
