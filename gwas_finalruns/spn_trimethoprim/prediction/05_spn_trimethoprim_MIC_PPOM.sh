#!/usr/bin/env bash
#SBATCH --job-name=spntmp_05_PPOM_pred
#SBATCH --nodes=1
#SBATCH --cpus-per-task=80
#SBATCH --mem=650G
#SBATCH --time=12:00:00
#SBATCH --error=/nfs/research/jlees/jacqueline/thesis_results/gwas_spn_trimethoprim/prediction/05_spn_trimethoprim_MIC_PPOM/logs/05_spn_trimethoprim_MIC_PPOM.err
#SBATCH --output=/nfs/research/jlees/jacqueline/thesis_results/gwas_spn_trimethoprim/prediction/05_spn_trimethoprim_MIC_PPOM/logs/05_spn_trimethoprim_MIC_PPOM.out
...
mkdir -p /nfs/research/jlees/jacqueline/thesis_results/gwas_spn_trimethoprim/prediction/05_spn_trimethoprim_MIC_PPOM/logs
...
OUTPUT_DIR="--output_directory /nfs/research/jlees/jacqueline/thesis_results/gwas_spn_trimethoprim/prediction/05_spn_trimethoprim_MIC_PPOM"
THREADS="--threads 80"
