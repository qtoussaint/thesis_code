#!/usr/bin/env bash
#SBATCH --job-name=kEF30_prn
#SBATCH --nodes=1
#SBATCH --cpus-per-task=32
#SBATCH --mem=250G
#SBATCH --time=24:00:00
#SBATCH --error=/nfs/research/jlees/jacqueline/thesis_results/gwas_klebsiella_homoplasic/inference/kleb_homoplasic_EF30_H09_continuous_pruned/logs/kleb_homoplasic_EF30_H09_continuous_pruned_%j.err
#SBATCH --output=/nfs/research/jlees/jacqueline/thesis_results/gwas_klebsiella_homoplasic/inference/kleb_homoplasic_EF30_H09_continuous_pruned/logs/kleb_homoplasic_EF30_H09_continuous_pruned_%j.out
...
mkdir -p /nfs/research/jlees/jacqueline/thesis_results/gwas_klebsiella_homoplasic/inference/kleb_homoplasic_EF30_H09_continuous_pruned/logs
...
ANALYSIS_NICKNAME="--analysis_nickname kleb_homoplasic_EF30_H09_continuous_pruned"
OUTPUT_DIR="--output_directory /nfs/research/jlees/jacqueline/thesis_results/gwas_klebsiella_homoplasic/inference/kleb_homoplasic_EF30_H09_continuous_pruned"
THREADS="--threads 32"
